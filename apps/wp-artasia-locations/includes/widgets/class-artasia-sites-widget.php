...
class Artasia_Sites_Elementor_Widget extends \Elementor\Widget_Base
{
    ...
    protected function register_controls(): void
    {
        ...
        $this->add_control('sites_instructions', [
            ...
            'raw'  => sprintf(
                '<p>Manage site assignments in <a href="%s" target="_blank" rel="noopener noreferrer">Artasia Placements</a>. Each published placement must be connected to the selected project and a partner.</p>',
