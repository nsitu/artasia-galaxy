...
function artasia_register_post_types(): void
{
    ...
    register_post_type('artasia_supporter', [
        'labels' => [
            'name'          => 'Artasia Supporters',
            'singular_name' => 'Artasia Supporter',
            'add_new_item'  => 'Add New Artasia Supporter',
            'edit_item'     => 'Edit Artasia Supporter',
            'new_item'      => 'New Artasia Supporter',
            'view_item'     => 'View Artasia Supporter',
            'search_items'  => 'Search Artasia Supporters',
            'not_found'     => 'No Artasia supporters found',
        ],
        'public'       => false,
        'publicly_queryable' => false,
        'show_ui'      => true,
    ...
    register_post_type('artasia_recognition', [
        'labels' => [
            'name'          => 'Artasia Recognitions',
            'singular_name' => 'Artasia Recognition',
            'add_new_item'  => 'Add New Artasia Recognition',
            'edit_item'     => 'Edit Artasia Recognition',
            'new_item'      => 'New Artasia Recognition',
            'view_item'     => 'View Artasia Recognition',
            'search_items'  => 'Search Artasia Recognitions',
            'not_found'     => 'No Artasia recognitions found',
        ],
        'public'       => false,
        'publicly_queryable' => false,
        'show_ui'      => true,
    ...
    register_post_type('artasia_exhibition', [
        'labels' => [
            'name'          => 'Artasia Exhibitions',
            'singular_name' => 'Artasia Exhibition',
            'add_new_item'  => 'Add New Artasia Exhibition',
            'edit_item'     => 'Edit Artasia Exhibition',
            'new_item'      => 'New Artasia Exhibition',
            'view_item'     => 'View Artasia Exhibition',
            'search_items'  => 'Search Artasia Exhibitions',
            'not_found'     => 'No Artasia exhibitions found',
        ],
        'public'       => false,
        'publicly_queryable' => false,
        'show_ui'      => true,
...
function artasia_register_admin_menu(): void
{
    ...
    add_submenu_page(
        ...
        'Supporters',
        'edit_posts',
        'edit.php?post_type=artasia_supporter'
    );
    ...
    add_submenu_page(
        ...
        'Exhibitions',
        'edit_posts',
        'edit.php?post_type=artasia_exhibition'
    );
...
{
    $artasia_post_types = ['artasia_project', 'artasia_activity', 'artasia_partner', 'artasia_supporter', 'artasia_place', 'artasia_people', 'artasia_role', 'artasia_recognition', 'artasia_exhibition', 'artasia_placement', 'artasia_document', 'artasia_anecdote'];
